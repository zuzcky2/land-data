...
class BlockAddressMongodbDriver(AbstractMongodbDriver, DriverInterface):

    @property
    def primary_key(self) -> str:
        return 'block_address_id'

    @property
    def collection(self) -> Collection:
        return db.get_mongodb_driver('mongodb') \
                            .get_database('landmark') \
                            .get_collection('location_raw_block_address')

    @property
    def convert_types(self) -> dict:
        return {
            'block_address_id': str
        }