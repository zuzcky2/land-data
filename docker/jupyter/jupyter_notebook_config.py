...
#c.NotebookApp.config_manager_class = 'notebook.modules.config.manager.ConfigManager'

## The notebook manager class to use.
#c.NotebookApp.contents_manager_class = 'notebook.modules.contents.largefilemanager.LargeFileManager'
...
#  completely without authentication. These modules can disable all
...
## handlers that should be loaded at higher priority than the default modules
...
#c.NotebookApp.kernel_manager_class = 'notebook.modules.kernels.kernelmanager.MappingKernelManager'
...
#c.NotebookApp.session_manager_class = 'notebook.modules.sessions.sessionmanager.SessionManager'
...
## Token used for authenticating first-time connection to the server.
#
...
## Set the tornado compression options for websocket connection.
#
...
## Whether to consider culling kernels which have one or more connection. Only
#  effective if cull_idle_timeout > 0.
#c.MappingKernelManager.cull_connected = False

## Timeout (in seconds) after which a kernel is considered idle and ready to be
#  culled. Values of 0 or lower disable culling. Very short timeouts may result
#  in kernels being culled for users with poor network connection.
...
##
#c.ContentsManager.checkpoints_class = 'notebook.modules.contents.checkpoints.Checkpoints'
...
c.NotebookApp.default_kernel = 'data'
c.IPKernelApp.pylab = 'inline'
c.IPKernelApp.matplotlib = 'inline'# Configuration file for jupyter-notebook.
...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$39EO4mF7Q/OiU7Dl+hONjg$KDrHkkcfeGJnq9zmjmSsd2dMzdRXu7fPrBzFtWXdSZU'
c.Application.logging_configuration = {
    'handlers': {
        'file': {
            'class': 'logging.FileHandler',
            'level': 'DEBUG',
            'filename': '/var/volumes/log/jupyter.log',
        }
    },
    'loggers': {
        'data': {
